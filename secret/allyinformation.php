...
if (isset($_GET['id'])) {
    ...
    if ($ally_information !== false) {
        ...
        <div style="width: 90%; margin-left:20px;">
            <div id="tabcontainer" jsId="tabcontainer" dojoType="dijit.layout.TabContainer" style="width: 100%;"
                 doLayout=false>
                <div id="tab1" jsId="tab1" dojoType="dijit.layout.ContentPane"
                     title="<?php echo DETAILEDINFO_GENERAL; ?>" selected="true">
                    <table cellpadding="5" cellspacing="0" border="0" align="center" width="100%">
                        <tr>
                            <td style="width:200px"><?php echo STATS_ALLYNAME; ?></td>
                            <td>
                                <a href="<?php echo $stats_url; ?>">
                                    <span id="pn_<?php echo $alliance_id; ?>"
                                          class="<?php echo $ally_information['dipl_status']; ?>"
                                          style="text-decoration:underline;"><?php echo $ally_information['allyname']; ?> - (<?php echo STATS_MEMBERS; ?>: <?php echo $ally_members; ?>)</span>
                                </a>
                                <?php
                                if ($_SESSION['s_auth']->get_permission(iAuthorization::permission_diplomatic) === true) {
                                    ?>
                                    <div dojoType="dijit.form.DropDownButton" id="allystatus_button"
                                         jsId="allystatus_button">
                                        <span><?php echo STATS_CHANGE_ALLIANCE_STATUS; ?></span>
                                        <div dojoType="dijit.Menu">
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'nothing')">
                                                <?php echo '<span class="nothing">' . STATS_NOTHING . "</span>"; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'nap')">
                                                <?php echo '<span class="nap">' . STATS_NAP . "</span>"; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'ally')">
                                                <?php echo '<span class="ally">' . STATS_ALLIED . "</span>";; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'war')">
                                                <?php echo '<span class="war">' . STATS_WAR . "</span>";; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'boycott')">
                                                <?php echo '<span class="boycott">' . STATS_BOYCOTT . "</span>";; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'neutral')">
                                                <?php echo '<span class="neutral">' . STATS_NEUTRAL . "</span>";; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'own')">
                                                <?php echo '<span class="own">' . STATS_OWN . "</span>";; ?>
                                            </div>
                                            <div dojoType="dijit.MenuItem"
                                                 onClick="galaxytool.AllyInfo.changeAllyStatus(<?php echo $alliance_id; ?>, 'wing')">
                        ...
                        $defscore = ($ally_information['defrank'] > 0) ? DETAILEDINFO_RANK . ": " . $ally_information['defrank'] . " " . DETAILEDINFO_POINTS . " " . number_format($ally_information['defpoints'], 0, ",", ".") : DETAILEDINFO_UNKNOWN;
                        ?>
                        <tr>
                            <td><?php echo DETAILEDINFO_SCORE; ?></td>
                            <td><?php echo $score; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo STATS_ECONOMY; ?></td>
                            <td><?php echo $escore; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo DETAILEDINFO_RESEARCH; ?></td>
                            <td><?php echo $rscore; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo STATS_MILITARY; ?></td>
                            <td><?php echo $fscore; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo DETAILEDINFO_DEFENCE_SCORE; ?></td>
                            <td>
                                <span id="TooltipDefenceScore" class="hyperlink"
                                      onmouseover="dijit.Tooltip.defaultPosition=['above', 'below']"><?php echo $defscore; ?></span>
                                <div class="dijitHidden"><span data-dojo-type="dijit.Tooltip"
                                                               data-dojo-props="connectId:'TooltipDefenceScore'"><?php echo DETAILEDINFO_DEFENCE_SCORE_TOOLTIP; ?></span>
                                </div>
                            </td>
                        </tr>
                        <!--		<tr><td>--><?php //echo STATS_HONOUR; ?><!--</td><td>-->
                        <?php //echo $hscore; ?><!--</td></tr>-->
                        <!--		<tr><td>--><?php //echo STATS_MILITARY_BUILD; ?><!--</td><td>-->
                        <?php //echo $fbscore; ?><!--</td></tr>-->
                        <!--		<tr><td>--><?php //echo STATS_MILITARY_DESTROYED; ?><!--</td><td>-->
                        <?php //echo $fdscore; ?><!--</td></tr>-->
                        <!--		<tr><td>--><?php //echo STATS_MILITARY_LOST; ?><!--</td><td>-->
                        <?php //echo $flscore; ?><!--</td></tr>-->
                        <?php
                        ...
                        ?>
                        <tr>
                            <td><?php echo DETAILEDINFO_KNOWN_PLANETS; ?></td>
                            <td><?php echo "<strong>" . $planets . "</strong> - " . $planet_coordinates; ?></td>
                        </tr>
                        <tr>
                            <td><?php echo DETAILEDINFO_MOONS; ?></td>
                            <td><?php echo "<strong>" . $moons . "</strong> - " . $moon_coordinates; ?></td>
                        </tr>
                        <?php
                ...
                <div id="tab2" jsId="tab2" dojoType="dijit.layout.ContentPane"
                     title="<?php echo DETAILEDINFO_MEMBERS; ?>">
                    <table dojoType="dojox.grid.DataGrid" jsId="grid1" id="grid1" escapeHTMLInData="false"
                           style="width: 100%; margin: 5 0 0 0;" clientSort="true" sortinfo="1" autoHeight="true"
                           selectable="true">
                        <thead>
                        <tr>
                            <th width="150px;" field="playername"
                                formatter="galaxytool.AllyInfo.playerFormatter"><?php echo STATS_PLAYERNAME; ?></th>
                            <th width="50px;" field="status"
                                formatter="galaxytool.AllyInfo.centeredFormatter"><?php echo STATS_STATUS; ?></th>
                            <th width="100px;" field="score"
                                formatter="galaxytool.AllyInfo.scoreFormatter"><?php echo DETAILEDINFO_SCORE; ?></th>
                            <th width="100px;" field="economy"
                                formatter="galaxytool.AllyInfo.scoreFormatter"><?php echo STATS_ECONOMY; ?></th>
                            <th width="100px;" field="fleet"
                                formatter="galaxytool.AllyInfo.scoreFormatter"><?php echo STATS_MILITARY; ?></th>
                            <th width="auto" field="research"
                                formatter="galaxytool.AllyInfo.scoreFormatter"><?php echo DETAILEDINFO_RESEARCH; ?></th>
                        </tr>
                        </thead>
                    </table>
                    <br> <!-- // br needed to avoid drawing errors in dojo -->
                </div>
                <?php
                if ($_SESSION['s_auth']->get_permission(iAuthorization::permission_probeview) == true) {
                    $production = $allyinfo->get_production($alliance_id);
                    ?>
                    <div id="tab3" jsId="tab3" dojoType="dijit.layout.ContentPane"
                         title="<?php echo DETAILEDINFO_RESOURCES; ?>">
                        <table cellpadding="2" cellspacing="0" border="0" align="center" width="100%">
                            <tr>
                                <td style="width:200px;">&nbsp;</td>
                                <td style="font-weight:bold;"><?php echo DETAILEDINFO_METAL; ?></td>
                                <td style="font-weight:bold;"><?php echo DETAILEDINFO_CRYSTAL; ?></td>
                                <td style="font-weight:bold;"><?php echo DETAILEDINFO_DEUTERIUM; ?></td>
                            </tr>
                            <tr>
                                <td><?php echo DETAILEDINFO_RESOURCES_PER_HOUR; ?></td>
                                <td><?php echo number_format($production['metal'] * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['crystal'] * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['deuterium'] * $speed_rate, 0, ",", "."); ?></td>
                            </tr>
                            <tr>
                                <td><?php echo DETAILEDINFO_RESOURCES_PER_DAY; ?></td>
                                <td><?php echo number_format($production['metal'] * 24 * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['crystal'] * 24 * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['deuterium'] * 24 * $speed_rate, 0, ",", "."); ?></td>
                            </tr>
                            <tr>
                                <td><?php echo DETAILEDINFO_RESOURCES_PER_WEEK; ?></td>
                                <td><?php echo number_format($production['metal'] * 24 * 7 * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['crystal'] * 24 * 7 * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['deuterium'] * 24 * 7 * $speed_rate, 0, ",", "."); ?></td>
                            </tr>
                            <tr>
                                <td><?php echo DETAILEDINFO_RESOURCES_PER_MONTH; ?></td>
                                <td><?php echo number_format($production['metal'] * 24 * 30 * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['crystal'] * 24 * 30 * $speed_rate, 0, ",", "."); ?></td>
                                <td><?php echo number_format($production['deuterium'] * 24 * 30 * $speed_rate, 0, ",", "."); ?></td>
                            </tr>
                        </table>
                    </div>
                    <?php
                ...
                ?>
                <div id="tab4" jsId="tab4" dojoType="dijit.layout.ContentPane"
                     title="<?php echo DETAILEDINFO_GRAPHS; ?>"
                ...
                if ($_SESSION['s_auth']->get_permission(iAuthorization::permission_probeview) == true) {
                    ...
                    ?>
                    <div id="tab5" jsId="tab5" dojoType="dijit.layout.ContentPane"
                         title="<?php echo DETAILEDINFO_FLEET_TAB; ?>">
			...
			';
                    ...
                    <div id="tab6" jsId="tab6" dojoType="dijit.layout.ContentPane"
                         title="<?php echo DETAILEDINFO_TECH; ?>">
                        <table cellpadding="5" cellspacing="0" border="0" width="100%">
                            <?php
...
?>
    ...
    <div style="display:none;">
        <div data-dojo-type="dijit.TooltipDialog" closable="true" onMouseLeave="dijit.popup.close(reporttooltip);"
             id="reporttooltip">
