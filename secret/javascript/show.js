...
galaxytool.Show = {
    ...
    formatStatus: function(a, c, b) {
        b.customClasses.push("centered_text");
        c = ""; - 1 < a.indexOf("v") &&
            (c += '<span class="vacation">' + galaxytool.Show.globalNLS.PLAYER_VACATION_MODE + "</span>"); - 1 < a.indexOf("b") && (c += '<span class="banned">' + galaxytool.Show.globalNLS.PLAYER_BANNED + "</span>"); - 1 < a.indexOf("i") && (c += '<span class="inactive">' + galaxytool.Show.globalNLS.PLAYER_INACTIVE + "</span>"); - 1 < a.indexOf("I") && (c += '<span class="longinactive">' + galaxytool.Show.globalNLS.PLAYER_LONG_INACTIVE + "</span>"); - 1 < a.indexOf("o") && (c += '<span class="outlaw">' + galaxytool.Show.globalNLS.PLAYER_OUTLAW + "</span>");
        return c
    },
