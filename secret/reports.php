...
';
    ...
    <div dojoType="dojo.data.ItemFileReadStore" jsId="playerStore" id="playerStore"
         url="ajax/ajax_players.php?type=all"></div>
    <div dojoType="dojo.data.ItemFileReadStore" jsId="allyStore" id="allyStore"
         url="ajax/ajax_alliances.php?type=all"></div>

    <form id="report1" accept-charset="utf-8" dojoType="dijit.form.Form"
          onSubmit="return galaxytool.Reports.startSearch()">
        <div id="search1" dojoType="dijit.TitlePane" title="<?php echo REPORTS_SEARCH; ?>" open="true">
            ...
            <table>
                <tr>
                    ...
                    <td style="width: 200px;"><input dojoType="dijit.form.ComboBox" store="allyStore"
                                                     searchAttr="allyname" name="alliance" id="alliance" trim="true"
                ...
                <tr>
                    ...
                    <td><input dojoType="dijit.form.ComboBox" store="playerStore" searchAttr="player" name="player"
                               id="" player"" trim="true" style="width:130px;">
                    </td>
                    <td colspan="2">&nbsp;</td>
                </tr>
                <tr>
        ...
        <div id="search2" dojoType="dijit.TitlePane" title="<?php echo REPORTS_RESOURCES; ?>" open="true">
            <table>
                <tr>
                    ...
                    <td style="width: 200px;">
                        <select name="selection_metal" dojoType="dijit.form.Select" id="selection_metal"
                                jsId="selection_metal">
                            <option value="ge">&ge;</option>
                            <option value="eq">=</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="metal" type="text" dojoType="dijit.form.NumberTextBox" name="metal" value="0"
                               constraints="{min:0,places:0}" style="width: 100px;"></td>
                    <td style="width: 200px;"><?php echo $flipped_probe_array[R_CRYSTAL]; ?></td>
                    <td style="width: 200px;">
                        <select name="selection_crystal" dojoType="dijit.form.Select" id="selection_crystal"
                                jsId="selection_crystal">
                            <option value="ge">&ge;</option>
                            <option value="eq">=</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="crystal" type="text" dojoType="dijit.form.NumberTextBox" name="crystal" value="0"
                               constraints="{min:0,places:0}" style="width: 100px;"></td>
                </tr>
                <tr>
                    <td><?php echo $flipped_probe_array[R_DEUTERIUM]; ?></td>
                    <td>
                        <select name="selection_deuterium" dojoType="dijit.form.Select" id="selection_deuterium"
                                jsId="selection_deuterium">
                            <option value="ge">&ge;</option>
                            <option value="eq">=</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="deuterium" type="text" dojoType="dijit.form.NumberTextBox" name="deuterium" value="0"
                               constraints="{min:0,places:0}" style="width: 100px;"></td>
                    <td><?php echo $flipped_probe_array[R_ENERGY]; ?></td>
                    <td>
                        <select name="selection_energy" dojoType="dijit.form.Select" id="selection_energy"
                                jsId="selection_energy">
                            <option value="ge">&ge;</option>
                            <option value="eq">=</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="energy" type="text" dojoType="dijit.form.NumberTextBox" name="energy" value="0"
                               constraints="{min:0,places:0}" style="width: 100px;"></td>
                </tr>
                <tr>
                    <td><?php echo REPORTS_ALL_RESOURCES; ?></td>
                    <td>
                        <select name="selection_all_resources" dojoType="dijit.form.Select" id="selection_all_resources"
                                jsId="selection_all_resources">
                            <option value="ge">&ge;</option>
                            <option value="eq">=</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="all_resources" type="text" dojoType="dijit.form.NumberTextBox" name="all_resources"
                               value="0" constraints="{min:0,places:0}" style="width: 100px;"></td>
                    <td colspan="2">&nbsp;</td>
            </table>
        </div>
        ...
        foreach ($titlepanes as $titlepane) {
            ?>
            <div id="<?php echo $titlepane['id']; ?>" dojoType="dijit.TitlePane"
                 title="<?php echo $titlepane['text'];; ?>" open="false">
                <table>
                    <?php
                    switch ($titlepane['id']) {
                        case "search3":
        ...
        <div dojoType="dojo.data.ItemFileReadStore" jsId="userStore" id="userStore"
             url="ajax/ajax_users.php?type=all"></div>
        <div id="search7" dojoType="dijit.TitlePane" title="<?php echo REPORTS_STUFF; ?>" open="false">
            <table>
                <tr>
                    ...
                    <td style="width: 200px;">
                        <select name="selection_fleet_resis" dojoType="dijit.form.Select" id="selection_fleet_resis"
                                jsId="selection_fleet_resis">
                            <option value="ge">&ge;</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="fleet_resis" type="text" dojoType="dijit.form.NumberTextBox" name="fleet_resis"
                               value="0" constraints="{min:0,places:0}" style="width: 100px;"></td>
                    <td style="width: 200px;"><?php echo REPORTS_DEFENCE_SCORE; ?></td>
                    <td style="width: 200px;">
                        <select name="selection_defence_resis" dojoType="dijit.form.Select" id="selection_defence_resis"
                                jsId="selection_defence_resis">
                            <option value="ge">&ge;</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="defence_resis" type="text" dojoType="dijit.form.NumberTextBox" name="defence_resis"
                               value="0" constraints="{min:0,places:0}" style="width: 100px;"></td>
                </tr>
                <tr>
                    <td style="width: 200px;"><?php echo STATS_SCORE; ?></td>
                    <td style="width: 200px;">
                        <select name="selection_points" dojoType="dijit.form.Select" id="selection_points"
                                jsId="selection_points">
                            <option value="ge">&ge;</option>
                            <option value="le">&le;</option>
                        </select>
                        <input id="points" type="text" dojoType="dijit.form.NumberTextBox" name="points" value="0"
                               constraints="{min:0,places:0}" style="width: 100px;"></td>
                </tr>
                <tr>
                    <td><?php echo REPORTS_OWNER; ?></td>
                    <td><input data-dojo-type="dijit.form.FilteringSelect" value="0"
                               data-dojo-props="store:userStore, searchAttr:'username'" name="select_owner"
                               id="select_owner" style="width:100px">
                    </td>
                    <td><?php echo REPORTS_DEPTH; ?></td>
                    <td>
                        <select name="report_depth" dojoType="dijit.form.Select" id="report_depth" jsId="report_depth"
                                style="width:100px;">
                ...
                <tr>
                    ...
                    <td>
                        <select name="select_planetonly" dojoType="dijit.form.Select" id="show_only" jsId="show_only"
                                style="width:100px;">
                            <option value="-">-</option>
                    ...
                    <td>
                        <input id="age" type="text" dojoType="dijit.form.NumberTextBox" name="age" value=""
                               constraints="{min:1,places:0}" style="width: 100px;">&nbsp;<?php echo REPORTS_HOURS; ?>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <div><span class="inactive"><?php echo STATS_INACTIVE; ?>:</span>
                            <select name="select_inactive" dojoType="dijit.form.Select" id="select_inactive"
                                    jsId="select_inactive">
                                <option value="-">-</option>
                            ...
                            <select name="select_vacation" dojoType="dijit.form.Select" id="select_vacation"
                                    jsId="select_vacation">
                                <option value="-">-</option>
                                <option value="yes"><?php echo STATS_YES; ?></option>
                                <option value="no"><?php echo STATS_NO; ?></option>
                            </select>
                            <span style="margin-left: 25px;"><?php echo STATS_BANNED; ?>:</span>
                            <select name="select_banned" dojoType="dijit.form.Select" id="select_banned"
                                    jsId="select_banned">
                                <option value="-">-</option>
                                <option value="yes"><?php echo STATS_YES; ?></option>
                                <option value="no"><?php echo STATS_NO; ?></option>
                            ...
                            <select name="select_outlaw" dojoType="dijit.form.Select" id="select_outlaw"
                                    jsId="select_outlaw">
                                <option value="-">-</option>
                                <option value="yes"><?php echo STATS_YES; ?></option>
                                <option value="no"><?php echo STATS_NO; ?></option>
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="ally" style="width: 100px;">
                                    <input id="filter_allied" name="filter_allied" dojoType="dijit.form.CheckBox"
                                           value="1">
        ...
        <button dojoType="dijit.form.Button" type="submit"
                id="search_button"><?php echo REPORTS_SEARCH_SHORT; ?></button>
    ...
    <div id="result_view" style="display:none;">
        ...
        <div style="text-align: right;"><img src="../images/options.gif" class="hyperlink"
                                             onClick="dijit.byId('ColumnDialog').show();" alt="Options"></div>
        ...
        <table dojoType="dojox.grid.DataGrid" jsId="searchgrid" id="searchgrid" selectable="true"
               ...
               rowCount="0" rowsPerPage="200">
            <thead>
            <tr>
                <th width="60px;" field="address"
                    formatter="galaxytool.Reports.formatAddress"><?php echo SHOW_ADDRESS; ?></th>
            </tr>
            </thead>
        </table>
        <div style="margin: 0 0 0 15;">
            <img src="../images/arrow_up.png"> <a class="link" href="#"
                                                  onclick="galaxytool.Reports.checkboxSelection(true)"><?php echo COMBATS_CHECK_ALL; ?></a>/
            <a class="link" href="#"
               onclick="galaxytool.Reports.checkboxSelection(false)"><?php echo COMBATS_UNCHECK_ALL; ?></a>
            ...
            if ($_SESSION['s_auth']->get_permission(iAuthorization::permission_candelete) === true) {
                ...
                ?>
                <button dojoType="dijit.form.Button" type="button" id="delete_all_button" disabled="false"
                        iconClass="trashicon"
                        showLabel="false"
                        onclick="galaxytool.Reports.deleteSelected()"><?php echo REPORTS_DELETE ?></button>
                <?php
            }
            ?>
        </div>
...
?>
    <div id="ColumnDialog" dojoType="dijit.Dialog" style="width: 560px;"
         title="<?php echo GENERAL_COLUMN_HIDE_TITLE; ?>">
            ...
            <div dojoType="dijit.layout.ContentPane" title="">
                ...
                <form id="report_columns" accept-charset="utf-8">
                    <div id="columnspane1" dojoType="dijit.TitlePane" title="" open="true">
                        <table>
                            <tr>
                                <td><input id="column_address" name="column_address" checked
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_ADDRESS; ?></td>
                                <td><input id="column_moon" name="column_moon" checked dojoType="dijit.form.CheckBox"
                                           value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_MOON; ?></td>
                            </tr>
                            <tr>
                                <td><input id="column_ally" name="column_ally" checked dojoType="dijit.form.CheckBox"
                                           value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_ALLY; ?></td>
                                <td><input id="column_g_planet" name="column_g_planet" dojoType="dijit.form.CheckBox"
                                           value="true"></td>
                                <td style="width: 250px;"><?php echo SHOW_PLANET; ?></td>
                            </tr>
                            <tr>
                                <td><input id="column_player" name="column_player" checked
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_PLAYERNAME; ?></td>
                                <td><input id="column_datetime" name="column_datetime" checked
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_DATE; ?></td>
                            </tr>
                            <tr>
                                <td><input id="column_depth" name="column_depth" checked dojoType="dijit.form.CheckBox"
                                           value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_DEPTH; ?></td>
                                <td><input id="column_all_resources" name="column_all_resources" checked
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_RESOURCES; ?></td>
                            </tr>
                            <tr>
                                <td><input id="column_all_resis" name="column_all_resis" checked
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_ALL_RESIS; ?></td>
                                <td><input id="column_fleet_resis" name="column_fleet_resis"
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_FLEET_SCORE; ?></td>
                            </tr>
                            <tr>
                                <td><input id="column_defence_resis" name="column_defence_resis"
                                           dojoType="dijit.form.CheckBox" value="true"></td>
                                <td style="width: 250px;"><?php echo REPORTS_DEFENCE_SCORE; ?></td>
                                <td colspan="2"></td>
                            </tr>
                            <tr>
                                <td colspan="2"><a class="link" href="#"
                                                   onclick="galaxytool.Reports.columnSelection(1,true)"><?php echo COMBATS_CHECK_ALL; ?></a>/
                                    <a class="link" href="#"
                                       onclick="galaxytool.Reports.columnSelection(1,false)"><?php echo COMBATS_UNCHECK_ALL; ?></a>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    foreach ($all_db_keys as $array) {
                        switch ($i) {
                            case 1:
                                $title = REPORTS_RESOURCES;
                                break;
                            case 2:
                                $title = REPORTS_FLEET;
                                break;
                            case 3:
                                $title = REPORTS_DEFENCE;
                                break;
                            case 4:
                                $title = REPORTS_BUILDINGS;
                                break;
                            case 5:
                                $title = REPORTS_TECHNOLOGY;
                                break;
                            default:
                                $title = "";
                                break;
	    ...
	    <a class="link" href="#" onclick="galaxytool.Reports.columnSelection(' . $i . ',false)">' . COMBATS_UNCHECK_ALL . '</a></td>';
                    ...
                    ?>
                    <button dojoType="dijit.form.Button" type="button" id="columns_button"
                            onClick="galaxytool.Reports.changeLayout()"><?php echo GENERAL_APPLY; ?></button>
                </form>
            </div>
        </div>
    </div>
