...
class Layout {
	...
	public static function make_footer($universe,ErrorObject $message_object=null, $amd=false) {
		...
		$content .= '
	        ...
	        <div id="bottomPanel">
				<a href="https://chrome.google.com/webstore/detail/afmklcjabllgobbimodcfpbbkplmmeob/" target="external">Chrome Download</a>
				<a href="https://addons.mozilla.org/de/firefox/addon/galaxytoolbar-for-pr0game/" target="external">Firefox Download</a>
	        </div>
		';
