...
ob_start();
$parser = new pr0gameAPIParser($global_universe, $dbtablename, $systemtablename, $playertable, $allytable, $combattable, $combatparty, $noticetable, $playerhistory, $player_activity, $messagetable, false);

switch ($type) {
    case "reload_stats":
        $result = $parser->load_pr0game_statistics_data($validate->getUserId());
        break;
