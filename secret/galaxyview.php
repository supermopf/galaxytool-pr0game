...
<table cellpadding="0" cellspacing="0" border="0" align="center" style="width: 654px;">
	...
	<td align="left">
		...
		<input id="system" tabindex="2" type="text" dojoType="dijit.form.NumberTextBox" name="system"
        		value="<?php echo $system; ?>" constraints="{min:1,max:400,places:0}" required="true" style="width: 33px;">
...
for ($i=1; $i<16; $i++) {
	if (!array_key_exists($i, $data)) {
		...
		echo '
			<tr class="galaxy_row">
			<td class="galaxyview_spacer1"><div></div></td>
			<td class="galaxyview_pos"><div id="planetpos_'.$i.'" '.$class.'><a href="https://pr0game.com/game.php?page=fleetTable&galaxy='.$data[$i]['galaxy'].'&system='.$data[$i]['system'].'&planet='.$i.'&planettype=1&target_mission=6" target="_blank">'.$i.'</a></div></td>
